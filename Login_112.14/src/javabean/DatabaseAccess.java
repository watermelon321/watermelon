...
public class DatabaseAccess {
    ...
    public boolean perform(String sql) {
        boolean b = false;
        if(Login.username!=null)DBAccess();
        else DBAccess_user();
        try {
        	if(Login.username!=null)stm.execute(sql);
            else stm_user.execute(sql);
            b = true;
        } catch (Exception e) {
            System.out.println(e.toString());
        }
    ...
    public boolean createTable(String sql) {
        ...
        try {
        	if(Login.username!=null)stm.executeUpdate(sql);
            else stm_user.executeUpdate(sql);
    ...
    public ResultSet query(String sql) {
        ...
        try {
            ...
            else rs = stm_user.executeQuery(sql);
