...
public class Upload_shop {
	...
	public String execute() {
		...
		try {
			...
			int cnt=0;
			String sqlconfigure = "select * from history where Chinese like'%" + filenametmp + "%'";
			 ...
			 * 
			 * String RealPath = ServletActionContext.getServletContext()
			 * .getRealPath("/upload") + File.separator + getUploadFileName();
			 */
