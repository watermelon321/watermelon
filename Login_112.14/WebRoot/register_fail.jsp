...
.wrap {
	width:360px; height:150px; margin:380px auto; padding:30px 30px; background:rgba(255, 255, 255, 0.6)!important;
...
<div class="wrap"> 
<center><FONT style="FONT-SIZE: 10pt; FONT-FAMILY: 华文行楷," behavior=“alternative”, color=#000>Oops!用户名被占用啦!</FONT></center>
