...
<body>
	<div class="content dark style3">
		<div class="container">
			<div class="button scrolly">
			<center><FONT style="FONT-SIZE: 10pt; FONT-FAMILY: 华文行楷," behavior=“alternative”, color=#000>注册成功!现在登录吧！</FONT></center>
				<form action="login">
						...
						<fieldset>
							...
							<div class="inputWrap">
								<input type="password" name="Password"
									placeholder="请输入密码，请保证七位以上" required/>
							</div>
						</fieldset>
						<fieldset>
 							<input type="submit" value="登录">
							<a href="welcome.jsp">注册</a>
							<a href="index_final.jsp" class="back" color = "#fff">返回主界面</a>
						</fieldset>
					</div>
					</section>
				</form>
