		...
		<div id="content">
			<div id="home" class="section">
				...
				<div class="box home_box1 color5 no_mr">
					<a href="#contact"><img src="images/contact.jpg" alt="Contact" />
					</a>
				</div>
			...
			<div class="section section_with_padding" id="services">
				...
				<a href="#home" class="slider_nav_btn home_btn">home</a> <a
					href="#about" class="slider_nav_btn previous_btn">Previous</a> <a
					href="#amazon" class="slider_nav_btn next_btn">Next</a>
			</div>
			...
			<div class="section section_with_padding" id="portfolio">
				...
				<a href="#home" class="slider_nav_btn home_btn">home</a> <a
					href="#services" class="slider_nav_btn previous_btn">Previous</a> <a
			...
			<div class="section section_with_padding" id="testimonial">
				...
				<a href="#home" class="slider_nav_btn home_btn">home</a> <a
					href="#portfolio" class="slider_nav_btn previous_btn">Previous</a>
			...
			<div class="section section_with_padding" id="contact">
				...
				<div class="half left">
					...
					<div id="contact_form">
						<form method="post" name="contact" action="#contact">
							<div class="left">
								<label for="fullname">Name:</label> <input name="fullname"
									type="text" class="required input_field" id="fullname"
									maxlength="30" />
							</div>
							<div class="right">
				...
				<div class="half right">
					<h4>Address</h4>
					24/12 Duis lacinia dictum, <br /> Vestibulum auctor, 10120<br />
					Nam rhoncus, diam a mollis tempor<br /> Email: info@company.com<br />

					<div class="clear h20"></div>
					<div class="img_nom img_border">
						<span></span>
						<iframe width="340" height="200" frameborder="0" scrolling="no"
				...
				<a href="#home" class="slider_nav_btn home_btn">home</a> <a
					href="#testimonial" class="slider_nav_btn previous_btn">Previous</a>
				<a href="#home" class="slider_nav_btn next_btn">Next</a>
			</div>
		</div>
	</div>
