	...
	<section id="third" class="main">
		<div class="content dark style2">
			<div class="container"></div>
				<a href="index_final.jsp">返回上一页</a>
			...
			<tr>
			  <c:if test="${Curd.str1=='col1'}">  
				<c:if test="${Curd.str1!=NULL}">
                 <td><a href="delete_col?str1=${Curd.str1}"></a></td>
               </c:if>
               ...
               <c:if test="${Curd.str13<=judge}">
                 <td><a href="delete_col?str1=${Curd.str13}">删除</a></td>
               </c:if>
               <c:if test="${Curd.str14<=judge}">
                 <td><a href="delete_col?str1=${Curd.str14}">删除</a></td>
               </c:if>
                <c:if test="${Curd.str15<=judge}">
                 <td><a href="delete_col?str1=${Curd.str15}">删除</a></td>
               </c:if>
				</c:if>
